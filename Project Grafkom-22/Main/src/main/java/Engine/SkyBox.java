...
public class SkyBox extends ShaderProgram
{
    ...
    public SkyBox()
    {
        super(Arrays.asList(new ShaderProgram.ShaderModuleData("Project Grafkom-22\\Main\\resources\\shaders\\skybox.vert", GL_VERTEX_SHADER),
                new ShaderProgram.ShaderModuleData("Project Grafkom-22\\Main\\resources\\shaders\\skybox.frag", GL_FRAGMENT_SHADER)));
